...
var I18N_EN = {
  ...
  '导出全部': 'Export All',
  '单导邮箱': 'Emails Only',
  '单导邮箱 ({n} 个)': 'Export {n} emails only',
  '单导内容（每行一个邮箱）': 'One email per line',
  '已选 {n} 个': '{n} selected',
  '移动分组': 'Move to Group',
  '批量启用': 'Enable',
  '批量停用': 'Disable',
  ...
  '确认删除 {n} 个失效账号？此操作不可撤销。': 'Delete {n} invalid accounts? This cannot be undone.',
  '删除中...': 'Deleting...',
  '已删除 {n} 个失效账号': 'Deleted {n} invalid accounts',
  '导出选中': 'Export Selected',
  '单导选中邮箱': 'Selected Emails Only',
  '批量删除': 'Delete',
  '取消选择': 'Clear',
